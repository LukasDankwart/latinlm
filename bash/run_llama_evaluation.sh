...
nice -n 10 uv run python -m scripts.run_evaluation --eval-roberta --set-checkpoint=experiments/llama_run_1/checkpoint-23500/ --set-outputdir=experiments/llama_run_1/ --skip-judgment
