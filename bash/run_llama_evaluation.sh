...
nice -n 10 uv run python -m scripts.run_evaluation --eval-llama --set-checkpoint=experiments/llama_run_1/checkpoint-23500/ --set-evaldata=data/llama/eval/eval_data.json --set-outputdir=experiments/llama_run_1/ --skip-judgment
